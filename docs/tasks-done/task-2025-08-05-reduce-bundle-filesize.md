...
- Applying the build optimizations here: <https://v2.tauri.app/concept/size/>
- Applying some of the JS optimizations here: <https://v1.tauri.app/v1/guides/building/app-size/>
